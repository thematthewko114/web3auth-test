...
function MoonbeamLogin() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      const openloginAdapter = new OpenloginAdapter({
        adapterSettings: {
          ...
          loginConfig: {
            jwt: {
              name: "TEST NAME",
              verifier: "Web3Auth_test",
              typeOfLogin: "jwt",
              clientId: "BE-ZOyYe33e6M8fRpuZZPxIT7B33LFBfqU5jFsmxGr3CuEX6R7_Ue88FMivlK7_n35P2EeXZPMzcRVyUgVBhyoA",
            },
          },
        },
      });
      setWeb3auth(web3authObj);
      if(web3authObj){
        console.log(web3authObj)
        web3authObj.configureAdapter(openloginAdapter);
      }
  ...
  const login = async () => {
    ...
    const web3authProvider = web3auth?await web3auth.connectTo(WALLET_ADAPTERS.OPENLOGIN, {
      loginProvider: "jwt",
      extraLoginOptions: {
